...
@Autonomous(name="(DONT RUN) SlowSuperParkEarly", group="Red")
public class TheoreticalSuperAutoRedSlowParkEarly extends AutoBase {
    ...
    public void PickupSecond(){
        ...
        autoNav.AddTask(new MovementTask((long) (400/speed), 0, 1f, speed));
        autoNav.AddTask(new MovementTask((long) (1000/speed), 0, 0, speed));
    ...
    public void SecondPosition() {
        autoNav.AddTask(new MovementTask((long) (900), -90, -1f, 1f));
        autoNav.AddTask(new MovementTask((long) (500/speed), -90, 0, speed));
        autoNav.AddTask(new MovementTask((long) (500/speed), 0, 0, speed));
    ...
    public void SecondThirdPosition() {
        ...
        autoNav.AddTask(new MovementTask((long) (400/speed), -90, 0, -speed));
        autoNav.AddTask(new MovementTask((long) (900), -90, -1f, -1f));
        autoNav.AddTask(new MovementTask((long) (400), 0, -1f, -1f));
        autoNav.AddTask(new MovementTask((long) (1500), 0, 0, -1f));
